...
const ServiceCard = ({ service }: { service: Service }) => {
  ...
  return (
    <Card className="overflow-hidden rounded-3xl border-2 shadow-sm hover:shadow-xl transition-all duration-300 animate-fade-in group flex flex-col justify-between h-full bg-card">
        ...
        <CardContent className="p-5 space-y-4">
          ...
          <div className="space-y-1 text-right">
            ...
            <div className="flex flex-col gap-1">
              {/* 🚀 إضافة truncate لمنع تمدد النصوص وتشوه تناسق الكروت في الواجهة */}
      ...
      {/* 🚀 حاوية الأزرار التفاعلية مصقولة ومحمية من تضارب حواجز التوجيه الصارمة */}
        ...
        <div className="space-y-3">
          {role === 'provider' ? (
            isOwner ? (
              ...
              /* 🚀 حل مطب الانتقال المحظور: إذا كان المستخدم مزوداً ولكنه لا يملك الخدمة، نعطل الزر لحمايته من الطرد التلقائي */
              <Button 
                variant="ghost" 
                disabled
